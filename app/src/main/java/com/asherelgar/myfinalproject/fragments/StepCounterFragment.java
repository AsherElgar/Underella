...
import com.asherelgar.myfinalproject.BuildConfig;
...
//    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_step_counter, null);
        ...
        pg.addPieSlice(new PieModel("Freetime", 15, Color.parseColor("#FE6DA8")));
        pg.addPieSlice(new PieModel("Sleep", 25, Color.parseColor("#56B7F1")));
        pg.addPieSlice(new PieModel("Work", 30, Color.parseColor("#CDA67F")));
        pg.addPieSlice(new PieModel("Eating", 22, Color.parseColor("#FED70E")));
...
//    }
    ...
    public void onSensorChanged(final SensorEvent event) {
        if (BuildConfig.DEBUG)
            com.asherelgar.myfinalproject.Logger.log("UI - sensorChanged | todayOffset: " + todayOffset + " since boot: " +
                    event.values[0]);
    ...
    private void updatePie() {
        if (BuildConfig.DEBUG) Log.d("Hackeru", "UI - update steps: " + since_boot);
...
//            sliceGoal.setValue(goal - steps_today);
        ...
        if (showSteps) {
            ...
            calories.setText(formatter.format((total_start + steps_today) * 0.03));
        } else {
